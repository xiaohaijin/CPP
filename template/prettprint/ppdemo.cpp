...
*/
template <>
const pretty_print::delimiters_values<char> pretty_print::delimiters<std::vector<double>, char>::values = {"|| ", " : ",
                                                                                                           " ||"};
...
int main(int argc, char* argv[]) {
  ...
  */
  ...
  std::cout << "Custom, type-erased delimiters: " << pretty_print::custom_delims<MyDelims>(v) << std::endl;
  std::cout << "Custom, type-erased delimiters: " << pretty_print::custom_delims<MyDelims>(a2) << std::endl;
  std::cout << "Custom, type-erased delimiters: " << pretty_print::custom_delims<MyDelims>(a3) << std::endl;
